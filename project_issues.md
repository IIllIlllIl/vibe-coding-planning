...
| 2026-08-20 22:46 Europe/Luxembourg | Pre-launch check for the full native-HOME PolyBench evaluator-only repair; Iris user queue empty | 980009 | 0.124616 | 0.122658 | `LevelFS=0.472037`; FairShare is unchanged from the 14:48 observation. The repair reuses fixed Plan/Code checkpoints, invokes no LLM, and requests `1 CPU / 4G` for each eligible Evaluate worker. |
