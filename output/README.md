...
| `SWE-PolyBench/polybench-pcce-runs/formal/seed-python111-20260817/` | Formal seed-guideline PCCE deployment evaluation | PC/Code evidence complete; original Evaluate labels contaminated, prepared for an independent Evaluate-only repair |
