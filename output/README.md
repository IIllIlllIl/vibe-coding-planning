...
| `SWE-PolyBench/polybench-pce-runs/formal/python113-v11-pce-20260814/` | Complete local mirror of formal PCE trajectories, attempts, checkpoints, evaluator evidence and controller state | Environment-contaminated evaluator evidence; Plan/Code evidence remains reusable |
...
| `SWE-PolyBench/polybench-pcce-runs/formal/seed-python111-20260817/` | Formal seed-guideline PCCE deployment evaluation | PC/Code evidence complete; native-HOME repair completed 110 Evaluate tasks (68 resolved / 42 unresolved), with one Checker-exhausted case outside CE; 23-case dependency-preheat scope frozen in documentation |
