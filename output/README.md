...
| `SWE-PolyBench/polybench-guideline-validation-datasets/20260815_python111_testparsed_26dad63b5cf3/` | Derived PolyBench Checker-only validation snapshot | Frozen but score-unsafe pending evaluator rerun; 3 labels came from commands that did not execute |
