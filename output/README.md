...
| `SWE-PolyBench/polybench-pcce-runs/formal/seed-python99-clean-pce-v1-20260826/` | Corrected seed-guideline PCCE run and independent evaluator repairs | Formal upstream PCCE evidence is complete; the ordinary 62/99 score remains provisional until its prepared 21-case dependency-cache repair is completed and overlaid for paired comparison |
