"""Atomic PC and CE phase runners for SWE-Verified PCCE."""
...
from src.swe_verified_pcce.models import (
    CEAssignment,
    PCCECheckerCase,
    PCReviewAssignment,
)
        ...
        *,
        ...
        if checker_payload is None:
            checker_config = replace(
                ...
                checker=self.config.checker.checker,
            ...
            try:
                DockerChecker(checker_config, self.capacity)(
                    PCCECheckerCase(
                        assignment.case.source, str(plan_payload["plan"]), {}
